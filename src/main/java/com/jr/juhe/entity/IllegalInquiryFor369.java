...
public class IllegalInquiryFor369 {
    private String resultcode;
    private String reason;
    private String error_code;
    private IllegalInquiryListFor369 result;
    ...
    public IllegalInquiryListFor369 getResult() { return this.result; }


    public void setResult(IllegalInquiryListFor369 result) { this.result = result; }
